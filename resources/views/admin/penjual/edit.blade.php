...
<div class="max-w-xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-extrabold text-slate-900 tracking-tight font-display">Edit Akun Penjual</h2>
            <p class="text-xs text-slate-500 mt-0.5">Perbarui nama dan alamat email pengguna</p>
        </div>
        <a 
    ...
    <div class="card p-6 sm:p-8 bg-white border border-slate-200/80 shadow-sm">
        <form action="{{ route('admin.penjual.update', $penjual->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
