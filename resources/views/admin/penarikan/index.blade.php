...
<div class="space-y-6 pb-12">
    ...
    <div class="card p-5 bg-white border border-slate-200/80 shadow-sm rounded-2xl">
        <form method="GET" action="{{ route('admin.penarikan.index') }}" class="grid grid-cols-1 sm:grid-cols-4 gap-3 items-end">
            
            <div>
                <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-1.5">Status Payout</label>
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('admin.penarikan.index') }}" class="p-2 bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold text-xs rounded-xl transition" title="Reset">
