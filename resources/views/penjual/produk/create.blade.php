        ...
        <div class="card bg-white border border-slate-200/80 shadow-sm rounded-2xl overflow-hidden p-6 sm:p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" min="0" oninput="updateBagiHasil(); updateDiskonPreview();" class="w-full rounded-xl border-slate-200 bg-slate-50 text-sm focus:border-brand-500 focus:ring-brand-500 transition shadow-sm px-4 py-3 font-semibold" value="{{ old('harga') }}" placeholder="Contoh: 45000" required>
